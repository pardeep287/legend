...
class Department extends Model
{
    ...
    public function validateDepartment($inputs, $id = null)
    {
        // validation rule
        if ($id) {
            $rules['dept_name'] = 'required|unique:department_master,dept_name,' . $id .',id,deleted_at,NULL,company_id,'.loggedInCompanyId();
            $rules['dept_code'] = 'required|unique:department_master,dept_code,' . $id .',id,deleted_at,NULL,company_id,'.loggedInCompanyId();
        } else {
            $rules['dept_name'] = 'required|unique:department_master,dept_name,NULL,id,deleted_at,NULL,company_id,'.loggedInCompanyId();
            $rules['dept_code'] = 'required|unique:department_master,dept_code,NULL,id,deleted_at,NULL,company_id,'.loggedInCompanyId();
        }
